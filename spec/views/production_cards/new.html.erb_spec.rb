...
RSpec.describe "production_cards/new", :type => :view do
  before(:each) do
    assign(:production_card, ProductionCard.new(
  ...
  it "renders new production_card form" do
    render

    assert_select "form[action=?][method=?]", production_cards_path, "post" do
